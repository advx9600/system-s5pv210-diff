...
public class EthernetStateTracker extends Handler implements NetworkStateTracker {
    ...
    public boolean isConnectedOk(){
        if (localLOGV) Slog.v(TAG,"mStackConnected:"+mStackConnected+",mHWConnected:"+mHWConnected+",mNetworkInfo.isConnected():"+mNetworkInfo.isConnected());
