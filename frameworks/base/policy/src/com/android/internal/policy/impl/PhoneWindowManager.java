    ...
    public int finishAnimationLw() {
        ...
        if (mStatusBar != null) {
            ...
            if (mForceStatusBar) {
                ...
                // case though.
                if (topIsFullscreen || (Settings.System.getInt(mContext.getContentResolver(),Settings.System.COMBINED_BAR_FORCE_HIDE, 0) == 1)
		) {
                    if (mStatusBarCanHide || ((mFocusedWindow != null) && (Settings.System.getInt(mContext.getContentResolver(),Settings.System.COMBINED_BAR_FORCE_HIDE, 0) == 1) ) ||
